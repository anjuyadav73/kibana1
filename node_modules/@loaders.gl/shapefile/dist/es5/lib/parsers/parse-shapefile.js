...
function _parseShapefileInBatches() {
  _parseShapefileInBatches = (0, _wrapAsyncGenerator2["default"])(_regenerator["default"].mark(function _callee(asyncIterator, options, context) {
    var _ref, _ref$reproject, reproject, _ref$_targetCrs, _targetCrs, parseInBatches, fetch, url, _yield$_awaitAsyncGen, shx, cpg, prj, shapeIterator, propertyIterator, dbfResponse, shapeHeader, dbfHeader, iterator, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, _value, item, geometries, properties, _item, geojsonGeometries, features;

    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _ref = options && options.gis || {}, _ref$reproject = _ref.reproject, reproject = _ref$reproject === void 0 ? false : _ref$reproject, _ref$_targetCrs = _ref._targetCrs, _targetCrs = _ref$_targetCrs === void 0 ? 'WGS84' : _ref$_targetCrs;
            parseInBatches = context.parseInBatches, fetch = context.fetch, url = context.url;
            _context.next = 4;
          ...
          case 4:
            ...
            _context.next = 10;
            return (0, _awaitAsyncGenerator2["default"])(parseInBatches(asyncIterator, _shpLoader.SHPLoader, options));

          case 10:
            shapeIterator = _context.sent;
            _context.next = 13;
            return (0, _awaitAsyncGenerator2["default"])(fetch(replaceExtension(url, 'dbf')));
          ...
          case 13:
            ...
            _context.next = 17;
            return (0, _awaitAsyncGenerator2["default"])(parseInBatches(dbfResponse, _dbfLoader.DBFLoader, _objectSpread(_objectSpread({}, options), {}, {
              dbf: {
                encoding: cpg || 'latin1'
              }
            })));
          ...
          case 17:
            propertyIterator = _context.sent;

          case 18:
            _context.next = 20;
            return (0, _awaitAsyncGenerator2["default"])(shapeIterator.next());
          ...
          case 25:
            ...
            _context.next = 29;
            return (0, _awaitAsyncGenerator2["default"])(propertyIterator.next());
          ...
          case 34:
            ...
            _context.next = 37;
            return (0, _awaitAsyncGenerator2["default"])((0, _zipBatchIterators.zipBatchIterators)(shapeIterator, propertyIterator));
    ...
    }, _callee, null, [[43, 67, 71, 81], [72,, 76, 80]]);
  }));
  return _parseShapefileInBatches.apply(this, arguments);
}
...
function _parseShapefile() {
  _parseShapefile = (0, _asyncToGenerator2["default"])(_regenerator["default"].mark(function _callee2(arrayBuffer, options, context) {
    var _ref2, _ref2$reproject, reproject, _ref2$_targetCrs, _targetCrs, parse, _yield$loadShapefileS, shx, cpg, prj, _yield$parse, header, geometries, geojsonGeometries, properties, url, fetch, dbfResponse, features;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            _context2.next = 10;
            return parse(arrayBuffer, _shpLoader.SHPLoader, options);

          case 10:
            _yield$parse = _context2.sent;
            header = _yield$parse.header;
            geometries = _yield$parse.geometries;
            geojsonGeometries = parseGeometries(geometries);
            properties = [];
            url = context.url, fetch = context.fetch;
            _context2.next = 18;
            return fetch(replaceExtension(url, 'dbf'));
          ...
          case 18:
            ...
            _context2.next = 22;
            return parse(dbfResponse, _dbfLoader.DBFLoader, {
              dbf: {
                encoding: cpg || 'latin1'
              }
            });
...
function parseGeometries(geometries) {
  ...
  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
      ...
      geojsonGeometries.push((0, _gis.binaryToGeoJson)(geom, geom.type, 'geometry'));
    }
  } catch (err) {
    _iterator2.e(err);
  } finally {
