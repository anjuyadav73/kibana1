...
exports["default"] = parseSHP;
exports.parseSHPHeader = parseSHPHeader;

var _binaryReader = _interopRequireDefault(require("../../streaming/binary-reader"));
...
function parseSHP(arrayBuffer, options) {
  var binaryReader = new _binaryReader["default"](arrayBuffer);
  ...
  while (binaryReader.hasAvailableBytes(SHP_RECORD_HEADER_SIZE + 4)) {
    ...
    if (invalidRecord) {
      ...
      geometries.push((0, _parseShpGeometry.parseRecord)(recordView, options));
      currentIndex++;
    }
  }
