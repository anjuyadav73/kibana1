...
function parsePoint(view, offset, dim) {
  ...
  var _parsePositions2 = _slicedToArray(_parsePositions, 2);
...
function parseMultiPoint(view, offset, dim) {
  ...
  var _parsePositions4 = _slicedToArray(_parsePositions3, 2);
  ...
  if (dim === 4) {
    ...
    var _parsePositions6 = _slicedToArray(_parsePositions5, 2);
  ...
  if (dim >= 3) {
    ...
    var _parsePositions8 = _slicedToArray(_parsePositions7, 2);
...
function parsePoly(view, offset, dim, type) {
  ...
  var _parsePositions10 = _slicedToArray(_parsePositions9, 2);
  ...
  if (dim === 4) {
    ...
    var _parsePositions12 = _slicedToArray(_parsePositions11, 2);
  ...
  if (dim >= 3) {
    ...
    var _parsePositions14 = _slicedToArray(_parsePositions13, 2);
