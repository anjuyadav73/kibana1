...
export function zipBatchIterators(_x, _x2) {
  return _zipBatchIterators.apply(this, arguments);
}

function _zipBatchIterators() {
  _zipBatchIterators = _wrapAsyncGenerator(_regeneratorRuntime.mark(function _callee(iterator1, iterator2) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            _context.next = 8;
            return _awaitAsyncGenerator(iterator1.next());
          ...
          case 14:
            ...
            _context.next = 17;
            return _awaitAsyncGenerator(iterator2.next());
