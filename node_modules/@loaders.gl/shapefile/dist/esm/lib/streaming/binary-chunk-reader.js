...
var BinaryChunkReader = function () {
  function BinaryChunkReader(options) {
    _classCallCheck(this, BinaryChunkReader);
  ...
  _createClass(BinaryChunkReader, [{
    key: "write",
    ...
    value: function getDataView(bytes) {
      ...
      if (bufferOffsets.length === 1) {
        var _bufferOffsets$ = _slicedToArray(bufferOffsets[0], 2),
            bufferIndex = _bufferOffsets$[0],
            _bufferOffsets$$ = _slicedToArray(_bufferOffsets$[1], 2),
    ...
    value: function _combineArrayBuffers(bufferOffsets) {
      ...
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          ...
          var _bufferOffset$ = _slicedToArray(bufferOffset[1], 2),
      ...
      try {
        for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
          ...
          var _bufferOffset2 = _slicedToArray(_bufferOffset, 2),
              bufferIndex = _bufferOffset2[0],
              _bufferOffset2$ = _slicedToArray(_bufferOffset2[1], 2),
...
export { BinaryChunkReader as default };
