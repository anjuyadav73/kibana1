...
export function configure(configuration) {
    var marbles = _configure(__assign(__assign(__assign({}, defaults()), { assertDeepEqual: function (a, e) { return expect(a).toStrictEqual(e); }, frameworkMatcher: true }), configuration)).marbles;
