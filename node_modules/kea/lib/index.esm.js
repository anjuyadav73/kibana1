...
function applyInputToLogic(logic, input) {
  ...
  if (input.inherit) {
    for (var _iterator = input.inherit, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
      var _ref;
      ...
      var inheritLogic = _ref;

      for (var _iterator2 = inheritLogic.inputs, _isArray2 = Array.isArray(_iterator2), _i2 = 0, _iterator2 = _isArray2 ? _iterator2 : _iterator2[Symbol.iterator]();;) {
        var _ref2;
        ...
        var inheritInput = _ref2;
        applyInputToLogic(logic, inheritInput);
      }
    }
  }

  for (var _iterator3 = buildOrder, _isArray3 = Array.isArray(_iterator3), _i3 = 0, _iterator3 = _isArray3 ? _iterator3 : _iterator3[Symbol.iterator]();;) {
    var _ref3;
    ...
    for (var _iterator5 = buildSteps[step], _isArray5 = Array.isArray(_iterator5), _i5 = 0, _iterator5 = _isArray5 ? _iterator5 : _iterator5[Symbol.iterator]();;) {
      var _ref5;
  ...
  if (input.extend) {
    for (var _iterator4 = input.extend, _isArray4 = Array.isArray(_iterator4), _i4 = 0, _iterator4 = _isArray4 ? _iterator4 : _iterator4[Symbol.iterator]();;) {
      var _ref4;
...
function createBlankLogic(_ref6) {
  var key = _ref6.key,
      path = _ref6.path,
      props = _ref6.props,
...
function setLogicDefaults(logic) {
  ...
  for (var _iterator6 = plugins.activated, _isArray6 = Array.isArray(_iterator6), _i6 = 0, _iterator6 = _isArray6 ? _iterator6 : _iterator6[Symbol.iterator]();;) {
    var _ref7;
...
function buildLogic(_ref8) {
  ...
  for (var _iterator7 = inputs, _isArray7 = Array.isArray(_iterator7), _i7 = 0, _iterator7 = _isArray7 ? _iterator7 : _iterator7[Symbol.iterator]();;) {
    var _ref9;
