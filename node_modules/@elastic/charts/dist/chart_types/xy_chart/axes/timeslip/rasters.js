...
var rasters = function (_a, timeZone) {
    ...
    var quarterHours = __assign(__assign({}, minutes), { unitMultiplier: 15, labeled: true, binStarts: millisecondBinStarts(15 * 60 * 1000) });
    ...
    var fiveMinutes = __assign(__assign({}, minutes), { unitMultiplier: 5, labeled: true, binStarts: millisecondBinStarts(5 * 60 * 1000) });
    ...
    var quarterMinutes = __assign(__assign({}, seconds), { unitMultiplier: 15, labeled: true, binStarts: millisecondBinStarts(15 * 1000) });
    ...
    var fiveSeconds = __assign(__assign({}, seconds), { unitMultiplier: 5, labeled: true, binStarts: millisecondBinStarts(5 * 1000) });
    ...
    var tenMilliseconds = __assign(__assign({}, milliseconds), { unitMultiplier: 10, labeled: true, minimumTickPixelDistance: minimumTickPixelDistance * millisecondDistanceMultiplier, binStarts: millisecondBinStarts(10) });
    var hundredMilliseconds = __assign(__assign({}, milliseconds), { unitMultiplier: 100, labeled: true, minimumTickPixelDistance: minimumTickPixelDistance * millisecondDistanceMultiplier, binStarts: millisecondBinStarts(100) });
