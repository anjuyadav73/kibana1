...
const __1 = require("..");
const doFilterValuesMatch = __1.helpers.doFilterValuesMatch;
const markSelectedFacetValuesFromFilters = __1.helpers.markSelectedFacetValuesFromFilters;
const mergeFilters = __1.helpers.mergeFilters;
...
describe("markSelectedFacetValuesFromFilters", () => {
    ...
    it("will mark selected facets as selected based on current filters, field name, and filter type", () => {
        const marked = markSelectedFacetValuesFromFilters(facet, filters, "states", "any");
