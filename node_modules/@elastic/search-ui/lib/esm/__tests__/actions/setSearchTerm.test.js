...
import { itResetsCurrent, itResetsFilters, itFetchesResults, itUpdatesURLState } from "../../test/sharedTests";
...
describe("#setSearchTerm", () => {
    function subject(term, { autocompleteResults, autocompleteSuggestions, refresh, initialState = {}, shouldClearFilters } = {}) {
        const { driver, stateAfterCreation, updatedStateAfterAction } = setupDriver({ initialState });
    ...
    itResetsCurrent(() => subject("test", { initialState: { current: 2 } }).state);
    itResetsFilters(() => subject("test", {
        initialState: {
            filters: [
                {
                    field: "filter1",
