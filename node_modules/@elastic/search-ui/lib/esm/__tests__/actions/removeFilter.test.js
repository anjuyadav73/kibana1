...
import { itResetsCurrent, itFetchesResults, itUpdatesURLState } from "../../test/sharedTests";
...
describe("#removeFilter", () => {
    ...
    itResetsCurrent(() => subject("field", "value", { initialState: { current: 2 } }));
    ...
    it("Removes all filters", () => {
        expect(subject("test", undefined, undefined, {
            initialFilters: [
                { field: "initial", values: ["value"], type: "all" },
                {
                    field: "test",
    ...
    it("Does other things", () => {
        expect(subject("test", undefined, "all", {
            initialFilters: [
                { field: "initial", values: ["value"], type: "all" },
                {
                    field: "test",
