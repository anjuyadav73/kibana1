...
import { colorizeColor } from './utils';
export var TMSService = /*#__PURE__*/function (_AbstractEmsService) {
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 17:
              ...
              tiles = sourceJson === null || sourceJson === void 0 ? void 0 : (_sourceJson$tiles = sourceJson.tiles) === null || _sourceJson$tiles === void 0 ? void 0 : _sourceJson$tiles.map(function (tileUrl) {
                var directUrl = _this._proxyPath + _this._getAbsoluteUrl(tileUrl);

                return _this._emsClient.extendUrlWithParams(directUrl);
              });
  ...
  */
  ...
  _createClass(TMSService, [{
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 2:
                ...
                url = tileJson === null || tileJson === void 0 ? void 0 : (_tileJson$sources$sou = tileJson.sources[sourceId]) === null || _tileJson$sources$sou === void 0 ? void 0 : (_tileJson$sources$sou2 = _tileJson$sources$sou.tiles) === null || _tileJson$sources$sou2 === void 0 ? void 0 : _tileJson$sources$sou2.pop();
                ...
                directUrl = this._proxyPath + this._getAbsoluteUrl(url);
        ...
        return regeneratorRuntime.wrap(function _callee12$(_context12) {
          while (1) {
            switch (_context12.prev = _context12.next) {
              case 0:
                format = _args12.length > 0 && _args12[0] !== undefined ? _args12[0] : 'vector';
                _context12.t0 = format;
                _context12.next = _context12.t0 === 'vector' ? 4 : _context12.t0 === 'raster' ? 12 : 20;
                break;
              ...
              case 9:
                ...
                return _context12.abrupt("return", Math.min.apply(Math, _toConsumableArray(Object.values(sources).map(function (_ref5) {
                  var minzoom = _ref5.minzoom;
                  return minzoom;
                }).filter(function (minzoom) {
              ...
              case 17:
                _ref6 = _context12.t2;
                minzoom = _ref6.minzoom;
                return _context12.abrupt("return", minzoom);
        ...
        return regeneratorRuntime.wrap(function _callee13$(_context13) {
          while (1) {
            switch (_context13.prev = _context13.next) {
              case 0:
                format = _args13.length > 0 && _args13[0] !== undefined ? _args13[0] : 'vector';
                _context13.t0 = format;
                _context13.next = _context13.t0 === 'vector' ? 4 : _context13.t0 === 'raster' ? 12 : 20;
                break;
              ...
              case 9:
                ...
                return _context13.abrupt("return", Math.max.apply(Math, _toConsumableArray(Object.values(sources).map(function (_ref8) {
                  var maxzoom = _ref8.maxzoom;
                  return maxzoom;
                }).filter(function (maxzoom) {
              ...
              case 17:
                _ref9 = _context13.t2;
                maxzoom = _ref9.maxzoom;
                return _context13.abrupt("return", maxzoom);
    ...
    key: "transformLanguageProperty",
    value: function transformLanguageProperty(layer, lang) {
      var supportedLang = this.SupportedLanguages.find(function (l) {
        return l.key === lang;
      });

      if (layer.type === 'symbol' && layer.layout !== undefined && supportedLang !== undefined) {
        var omtLang = supportedLang.omt;
    ...
    */
    ...
    key: "transformColorProperties",
    value: function transformColorProperties(layer, color, operation, percentage) {
      if (['background', 'fill', 'line', 'symbol'].indexOf(layer.type) !== -1 && layer.paint) {
        ...
        var types = Object.keys(paint).filter(function (key) {
        ...
        return types.map(function (type) {
          var paintColor = paint[type];
          return {
            property: type,
            color: paintColor && color ? colorizeColor(paintColor, color, operation, percentage) : paintColor
          };
        });
      } else {
        return [];
    ...
    key: "_getTextField",
    value: function _getTextField(label, lang) {
      // Capture {name:xx} labels
      var labelMatch = label.match(/\{name([:_])(.{2})\}/);

      if (labelMatch && labelMatch[1] != lang) {
        // Only apply if the languages are different
        return ['coalesce', ['get', "name:".concat(lang)], ['get', "name".concat(labelMatch[1]).concat(labelMatch[2])]];
      } else if (label.includes('latin') && label.includes('nonlatin')) {
        // Capture the common pattern {name:latin}\n{name:nonlatin}
        return ['coalesce', ['get', "name:".concat(lang)], ['concat', ['get', 'name:latin'], '\n', ['get', 'name:nonlatin']]];
