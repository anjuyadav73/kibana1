...
it("supports a render prop", () => {
    ...
    const wrapper = (0, enzyme_1.shallow)(react_1.default.createElement(SearchBox_1.SearchBoxContainer, Object.assign({}, params, { view: render }))).dive();
...
it("will keep focus prop in sync with view component", () => {
    ...
    const wrapper = (0, enzyme_1.mount)(react_1.default.createElement(SearchBox_1.SearchBoxContainer, Object.assign({}, params, { view: View })));
...
it("will pass autocompleteView prop through to the view", () => {
    let viewProps;
    const customAutocompleteView = () => react_1.default.createElement("div", null);
    (0, enzyme_1.shallow)(react_1.default.createElement(SearchBox_1.SearchBoxContainer, Object.assign({}, params, { autocompleteView: customAutocompleteView, view: (props) => {
            viewProps = props;
            return react_1.default.createElement("div", null);
        } }))).dive();
...
describe("autocompletedSuggestionsCount", () => {
    it("will calculate the total count of all suggestions", () => {
        let viewProps;
        (0, enzyme_1.shallow)(react_1.default.createElement(SearchBox_1.SearchBoxContainer, Object.assign({}, params, { autocompletedSuggestions: {
                documents: [
                    { suggestion: "carlsbad" },
    ...
    it("will calculate the total count of all suggestions when there are none", () => {
        let viewProps;
        (0, enzyme_1.shallow)(react_1.default.createElement(SearchBox_1.SearchBoxContainer, Object.assign({}, params, { autocompletedSuggestions: {}, autocompleteSuggestions: false, view: (props) => {
                viewProps = props;
                return react_1.default.createElement("div", null);
            } }))).dive();
        viewProps.onChange("new term");
...
describe("allAutocompletedItemsCount", () => {
    it("will calculate the total count of all autocomplete items", () => {
        let viewProps;
        (0, enzyme_1.shallow)(react_1.default.createElement(SearchBox_1.SearchBoxContainer, Object.assign({}, params, { autocompletedResults: [{ id: { raw: 1 } }, { id: { raw: 2 } }], autocompletedSuggestions: {
                documents: [
                    { suggestion: "carlsbad" },
                    { suggestion: "carlsbad caverns" },
                    { suggestion: "carolina" }
    ...
    it("will calculate the total count of all autocomplete items when there are none", () => {
        let viewProps;
        (0, enzyme_1.shallow)(react_1.default.createElement(SearchBox_1.SearchBoxContainer, Object.assign({}, params, { autocompleteResults: false, autocompletedResults: [], autocompleteSuggestions: false, autocompletedSuggestions: {}, view: (props) => {
                viewProps = props;
                return react_1.default.createElement("div", null);
            } }))).dive();
        viewProps.onChange("new term");
...
describe("useAutocomplete", () => {
    it("will be true if autocompleteResults configuration has been provided", () => {
        let viewProps;
        (0, enzyme_1.shallow)(react_1.default.createElement(SearchBox_1.SearchBoxContainer, Object.assign({}, params, { autocompleteResults: {
                titleField: "title",
                urlField: "nps_link"
            }, view: (props) => {
                viewProps = props;
    ...
    it("will be false if no autocomplete config has been provided", () => {
        let viewProps;
        (0, enzyme_1.shallow)(react_1.default.createElement(SearchBox_1.SearchBoxContainer, Object.assign({}, params, { view: (props) => {
                viewProps = props;
                return react_1.default.createElement("div", null);
            } }))).dive();
        viewProps.onChange("new term");
    ...
    it("will be true if autocompleteSuggestions configuration has been provided", () => {
        let viewProps;
        (0, enzyme_1.shallow)(react_1.default.createElement(SearchBox_1.SearchBoxContainer, Object.assign({}, params, { autocompleteSuggestions: {
                documents: {
    ...
    it("will be false if autocompleteMinimumCharacters is below threshold", () => {
        let viewProps;
        (0, enzyme_1.shallow)(react_1.default.createElement(SearchBox_1.SearchBoxContainer, Object.assign({}, params, { autocompleteMinimumCharacters: 4, autocompleteSuggestions: {
                documents: {
                    sectionTitle: "Suggested Queries"
                }
            }, view: (props) => {
...
describe("shouldClearFilters prop", () => {
    it("will be passed through to setSearchTerm on submit", () => {
        let viewProps;
        (0, enzyme_1.shallow)(react_1.default.createElement(SearchBox_1.SearchBoxContainer, Object.assign({}, params, { shouldClearFilters: false, view: (props) => {
                viewProps = props;
                return react_1.default.createElement("div", null);
            } }))).dive();
    ...
    it("will call setSearchTerm if no onSelectAutocomplete is specified and a suggestion is selected", () => {
        let viewProps;
        (0, enzyme_1.shallow)(react_1.default.createElement(SearchBox_1.SearchBoxContainer, Object.assign({}, params, { autocompleteResults: true, shouldClearFilters: false, view: (props) => {
                viewProps = props;
                return react_1.default.createElement("div", null);
            } }))).dive();
...
it("will call back to setSearchTerm with autocompleteMinimumCharacters setting", () => {
    let viewProps;
    (0, enzyme_1.shallow)(react_1.default.createElement(SearchBox_1.SearchBoxContainer, Object.assign({}, params, { autocompleteMinimumCharacters: 3, view: (props) => {
            viewProps = props;
            return react_1.default.createElement("div", null);
        } }))).dive();
    viewProps.onChange("new term");
...
it("will call back to setSearchTerm with refresh: true when input is changed and searchAsYouType is true", () => {
    let viewProps;
    (0, enzyme_1.shallow)(react_1.default.createElement(SearchBox_1.SearchBoxContainer, Object.assign({}, params, { searchAsYouType: true, view: (props) => {
            viewProps = props;
            return react_1.default.createElement("div", null);
        } }))).dive();
    expect(viewProps.value).toBe("test");
...
it("will call back to setSearchTerm with a specific debounce when input is changed and searchAsYouType is true and a debounce is provided", () => {
    let viewProps;
    (0, enzyme_1.shallow)(react_1.default.createElement(SearchBox_1.SearchBoxContainer, Object.assign({}, params, { searchAsYouType: true, debounceLength: 500, view: (props) => {
            viewProps = props;
            return react_1.default.createElement("div", null);
        } }))).dive();
    expect(viewProps.value).toBe("test");
...
it("will call back to setSearchTerm with a specific debounce when input is changed and autocompleteSuggestions is true and a debounce is provided", () => {
    let viewProps;
    (0, enzyme_1.shallow)(react_1.default.createElement(SearchBox_1.SearchBoxContainer, Object.assign({}, params, { autocompleteSuggestions: true, debounceLength: 500, view: (props) => {
            viewProps = props;
            return react_1.default.createElement("div", null);
        } }))).dive();
    expect(viewProps.value).toBe("test");
...
it("will call back setSearchTerm with refresh: true when form is submitted", () => {
    let viewProps;
    (0, enzyme_1.shallow)(react_1.default.createElement(SearchBox_1.SearchBoxContainer, Object.assign({}, params, { searchTerm: "a term", view: (props) => {
            viewProps = props;
            return react_1.default.createElement("div", null);
        } }))).dive();
    viewProps.onSubmit({
...
describe("onSelectAutocomplete", () => {
    it("will pass selection, option, default onSelectAutocomplete function to handler if provided", () => {
        ...
        const customOnSelectAutocomplete = (selection, { notifyAutocompleteSelected, completeSuggestion, autocompleteResults }, defaultOnSelectAutocomplete) => {
        ...
        (0, enzyme_1.shallow)(react_1.default.createElement(SearchBox_1.SearchBoxContainer, Object.assign({}, params, { autocompleteResults: true, onSelectAutocomplete: customOnSelectAutocomplete, view: (props) => {
                viewProps = props;
                return react_1.default.createElement("div", null);
            } }))).dive();
        const { onSelectAutocomplete } = viewProps;
    ...
    it("will call setSearchTerm if the default onSelectAutomplete is triggered with a suggestion", () => {
        let viewProps;
        (0, enzyme_1.shallow)(react_1.default.createElement(SearchBox_1.SearchBoxContainer, Object.assign({}, params, { autocompleteResults: true, view: (props) => {
                viewProps = props;
                return react_1.default.createElement("div", null);
            } }))).dive();
        const { onSelectAutocomplete } = viewProps;
...
describe("autocomplete clickthroughs", () => {
    ...
    it("will pass through tags", () => {
        ...
        const [documentId, tags] = params.trackAutocompleteClickThrough.mock.calls[0];
...
it("passes className through to the view", () => {
    ...
    (0, enzyme_1.shallow)(react_1.default.createElement(SearchBox_1.SearchBoxContainer, Object.assign({}, params, { className: className, view: (props) => {
            viewProps = props;
            return react_1.default.createElement("div", null);
        } }))).dive();
...
it("passes data-foo through to the view", () => {
    let viewProps;
    const data = "bar";
    (0, enzyme_1.shallow)(react_1.default.createElement(SearchBox_1.SearchBoxContainer, Object.assign({}, params, { "data-foo": data, view: (props) => {
            viewProps = props;
            return react_1.default.createElement("div", null);
        } }))).dive();
