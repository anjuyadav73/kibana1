...
it("renders correctly", () => {
    const wrapper = (0, enzyme_1.shallow)(react_1.default.createElement(Facet_1.FacetContainer, Object.assign({}, params)));
    expect(wrapper).toMatchSnapshot();
});
it("should not render a Facet if there are no facets available", () => {
    const wrapper = (0, enzyme_1.shallow)(react_1.default.createElement(Facet_1.FacetContainer, Object.assign({}, Object.assign(Object.assign({}, params), { facets: {} }))));
...
describe("values view prop", () => {
    function subject(filterType) {
        ...
        (0, enzyme_1.shallow)(react_1.default.createElement(Facet_1.FacetContainer, Object.assign({}, params, { field: "field1", filterType: filterType, filters: [
                {
                    field: "field2",
                    values: ["field1value1"],
                    type: "none"
...
describe("show more", () => {
    ...
    function subject(additionalProps = {}) {
        return (0, enzyme_1.shallow)(react_1.default.createElement(Facet_1.FacetContainer, Object.assign({}, Object.assign(Object.assign(Object.assign({}, params), { field: "field1", facets: {
                field1: [
                    {
                        field: "field1",
                        data: [
...
it("will add a filter when a facet value is selected with onSelect", () => {
    const wrapper = (0, enzyme_1.shallow)(react_1.default.createElement(Facet_1.FacetContainer, Object.assign({}, params, { filterType: "any" })));
...
it("passes className through to the view", () => {
    ...
    (0, enzyme_1.shallow)(react_1.default.createElement(Facet_1.FacetContainer, Object.assign({}, params, { className: className, view: View }))).dive();
...
it("passes data-foo through to the view", () => {
    ...
    (0, enzyme_1.shallow)(react_1.default.createElement(Facet_1.FacetContainer, Object.assign({}, params, { "data-foo": data, view: View }))).dive();
...
describe("search facets", () => {
    ...
    function subject(additionalProps = {}, data = fieldData) {
        return (0, enzyme_1.shallow)(react_1.default.createElement(Facet_1.FacetContainer, Object.assign({}, Object.assign(Object.assign(Object.assign({}, params), { field,
            label, facets: {
                field1: [
                    {
                        field,
            ...
            }, isFilterable: true }), additionalProps))));
    }
    beforeAll(() => {
        wrapper = subject();
    });
    ...
    it("should use the field name as a search input placeholder", () => {
        expect(wrapper.find(View).prop("searchPlaceholder")).toBe(`Filter ${label}`);
    });
