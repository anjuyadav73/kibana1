...
it("renders correctly", () => {
    const wrapper = shallow(React.createElement(Autocomplete, Object.assign({}, props)));
    expect(wrapper).toMatchSnapshot();
});
describe("When there are results", () => {
    it("will render results", () => {
        const wrapper = shallow(React.createElement(Autocomplete, Object.assign({}, props, { autocompleteResults: true, autocompleteSuggestions: false })));
    ...
    it("will NOT render results if autocompleteResults is false", () => {
        const wrapper = shallow(React.createElement(Autocomplete, Object.assign({}, props, { autocompleteResults: false, autocompleteSuggestions: false })));
    ...
    it("will render a results section title if one is provided", () => {
        const wrapper = shallow(React.createElement(Autocomplete, Object.assign({}, props, { autocompleteResults: {
                sectionTitle: "Results",
                titleField: "title",
                urlField: "nps_link",
                linkTarget: "_blank"
...
describe("When there are no results", () => {
    it("will NOT render results", () => {
        const wrapper = shallow(React.createElement(Autocomplete, Object.assign({}, props, { autocompletedResults: [], autocompleteResults: true, autocompleteSuggestions: false })));
        expect(wrapper.find(".sui-search-box__results-list").length).toEqual(0);
    });
    it("will NOT render a result section title", () => {
        const wrapper = shallow(React.createElement(Autocomplete, Object.assign({}, props, { autocompletedResults: [], autocompleteResults: {
                sectionTitle: "Results",
                titleField: "title",
                urlField: "nps_link",
                linkTarget: "_blank"
...
describe("When there are suggestions", () => {
    it("will render suggestions", () => {
        const wrapper = shallow(React.createElement(Autocomplete, Object.assign({}, props, { autocompleteResults: false, autocompleteSuggestions: true })));
        expect(wrapper.find(".sui-search-box__suggestion-list li").length).toEqual(6);
    });
    ...
    it("will render a suggestion section title if one is provided", () => {
        const wrapper = shallow(React.createElement(Autocomplete, Object.assign({}, props, { autocompleteResults: false, autocompleteSuggestions: {
                documents: {
                    sectionTitle: "Suggested"
                }
            } })));
...
describe("When there are no suggestions", () => {
    it("will NOT render suggestions", () => {
        const wrapper = shallow(React.createElement(Autocomplete, Object.assign({}, props, { autocompleteResults: false, autocompletedSuggestions: {}, autocompleteSuggestions: true })));
        expect(wrapper.find(".sui-search-box__suggestion-list").length).toEqual(0);
    });
    it("will NOT render a suggestion section title", () => {
        const wrapper = shallow(React.createElement(Autocomplete, Object.assign({}, props, { autocompleteResults: false, autocompletedSuggestions: {}, autocompleteSuggestions: {
                documents: {
                    sectionTitle: "Suggested"
                }
            } })));
...
it("renders with className prop applied", () => {
    ...
    const wrapper = shallow(React.createElement(Autocomplete, Object.assign({ className: customClassName }, props)));
