...
export declare function initLogger({ interactive, accessToken, logFilePath, }: {
    interactive: boolean;
    accessToken?: string;
    logFilePath?: string;
}): winston.Logger;
...
export declare function redactAccessToken(str: string): string;
export declare function accessTokenReplacer(key: string, value: unknown): unknown;
