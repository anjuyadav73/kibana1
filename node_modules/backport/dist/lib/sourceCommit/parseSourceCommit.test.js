...
const getMockSourceCommit_1 = require("./getMockSourceCommit");
const parseSourceCommit_1 = require("./parseSourceCommit");
describe('parseSourceCommit', () => {
    describe('pullNumber', () => {
        it('receives `pullNumber` from the associated pull request', () => {
            const mockSourceCommit = (0, getMockSourceCommit_1.getMockSourceCommit)({
                sourceCommit: { message: 'My commit message (#1234)' },
                sourcePullRequest: { number: 55 },
            });
            const commit = (0, parseSourceCommit_1.parseSourceCommit)({
...
//# sourceMappingURL=parseSourceCommit.test.js.map