...
exports.accessTokenReplacer = exports.redactAccessToken = exports.setAccessToken = exports.consoleLog = exports.initLogger = exports.logger = void 0;
...
function fileTransport({ logFilePath, logLevel, }) {
    return new winston_1.default.transports.File({
        ...
        level: logLevel,
        format: winston_1.format.json({ replacer: accessTokenReplacer }),
    });
}
...
function accessTokenReplacer(key, value) {
    return typeof value === 'string' ? redactAccessToken(value) : value;
}
exports.accessTokenReplacer = accessTokenReplacer;
