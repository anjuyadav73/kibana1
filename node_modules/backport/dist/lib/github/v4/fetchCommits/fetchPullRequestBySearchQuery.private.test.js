...
describe('fetchPullRequestsBySearchQuery', () => {
    describe('when filter does not match any PRs', () => {
        it('throws an error', async () => {
            ...
            await expect((0, fetchPullRequestsBySearchQuery_1.fetchPullRequestsBySearchQuery)(options)).rejects
    ...
    describe('when filter matches PRs', () => {
        it('returns the merge commits for those PRs', async () => {
            ...
            expect(await (0, fetchPullRequestsBySearchQuery_1.fetchPullRequestsBySearchQuery)(options)).toEqual(expectedCommits);
        });
    });
});
//# sourceMappingURL=fetchPullRequestBySearchQuery.private.test.js.map