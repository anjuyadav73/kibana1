...
const fetchPullRequestsBySearchQuery_1 = require("./fetchPullRequestsBySearchQuery");
const accessToken = (0, getDevAccessToken_1.getDevAccessToken)();
jest.setTimeout(15000);
describe('allFetchers', () => {
    let commitByAuthor;
    beforeEach(async () => {
        const commitsByAuthor = await (0, fetchCommitsByAuthor_1.fetchCommitsByAuthor)({
            accessToken,
            author: 'sqren',
            maxNumber: 1,
            repoName: 'kibana',
    ...
    it('matches commitByAuthor with commitByPullNumber', async () => {
        ...
        const commitByPullNumber = await (0, fetchCommitByPullNumber_1.fetchCommitsByPullNumber)({
            repoOwner: 'elastic',
            repoName: 'kibana',
            accessToken,
    ...
    it('matches commitByAuthor with commitBySha', async () => {
        const commitBySha = await (0, fetchCommitBySha_1.fetchCommitBySha)({
            repoOwner: 'elastic',
            repoName: 'kibana',
            accessToken,
    ...
    it('matches commitByAuthor with commitBySearchQuery', async () => {
        const commitsBySearchQuery = await (0, fetchPullRequestsBySearchQuery_1.fetchPullRequestsBySearchQuery)({
            accessToken,
            author: 'sqren',
            dateSince: null,
            dateUntil: null,
...
//# sourceMappingURL=allFetchers.private.test.js.map