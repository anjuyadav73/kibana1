...
async function apiRequestV4({ githubApiBaseUrlV4 = 'https://api.github.com/graphql', accessToken, query, variables, }) {
    ...
    const span = elastic_apm_node_1.default.startSpan(`GraphQL: ${gqlQueryName}`, 'external', 'graphql', 'query');
    //@ts-expect-error
    span?.setDbContext({ type: 'graphql', statement: (0, printer_1.print)(query) });
    try {
...
//# sourceMappingURL=apiRequestV4.js.map