...
exports.getRuntimeArguments = exports.getOptionsFromCliArgs = void 0;
const yargs_1 = __importDefault(require("yargs"));
const yargs_parser_1 = __importDefault(require("yargs-parser"));
const excludeUndefined_1 = require("../utils/excludeUndefined");
const options_1 = require("./options");
function getOptionsFromCliArgs(processArgs) {
    const yargsInstance = (0, yargs_1.default)(processArgs)
        ...
        description: 'Sets auto-merge method when using --auto-merge. Default: merge',
        type: 'string',
        ...
        description: 'Do not append commit message with "(cherry picked from commit...)"',
        type: 'boolean',
    ...
    multiple, multipleBranches, multipleCommits, all, 
    // shorthands
    repo, 
    // filters
    author, 
    // negations
    noCherrypickRef, noFork, noStatusComment, noVerify, verify, nonInteractive, noTelemetry, 
    // array types (should be renamed to plural form)
    assignee, path, reviewer, sourcePRLabel, targetBranch, targetBranchChoice, targetPRLabel, ...restOptions } = yargsInstance.parseSync();
...
function getRuntimeArguments(processArgs, optionsFromModule) {
    const { nonInteractive, json, logFilePath, ls } = (0, yargs_parser_1.default)(processArgs);
    const base = { ...options_1.defaultConfigOptions, ...optionsFromModule };
    return {
        interactive: nonInteractive === undefined && json === undefined
            ? base.interactive
...
exports.getRuntimeArguments = getRuntimeArguments;
