...
export declare function readConfigFile(filepath: string): Promise<ConfigFileOptions>;
export declare function withConfigMigrations({ upstream, labels, branches, ...config }: ConfigFileOptions): {
