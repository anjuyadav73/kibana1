...
export declare type OptionsFromConfigFiles = Awaited<ReturnType<typeof getOptionsFromConfigFiles>>;
export declare function getOptionsFromConfigFiles({ optionsFromCliArgs, optionsFromModule, }: {
    ...
    targetBranchChoices?: import("../ConfigOptions").TargetBranchChoiceOrString[] | undefined;
    ...
    branches?: import("../ConfigOptions").TargetBranchChoiceOrString[] | undefined;
