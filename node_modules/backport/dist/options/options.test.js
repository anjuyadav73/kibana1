...
describe('getOptions', () => {
    ...
    it('should ensure that "backport" branch does not exist', async () => {
        ...
        await expect((0, options_1.getOptions)({ optionsFromCliArgs: {}, optionsFromModule: {} })).rejects.toThrow('You must delete the branch "backport" to continue. See https://github.com/sqren/backport/issues/155 for details');
    });
